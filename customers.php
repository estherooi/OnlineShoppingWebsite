...
<head>
  ...
  <title>My Bed Linen Ordering System : Customers</title>
...
body {
  ...
  <div class="container-fluid">
    ...
    <form action="customers.php" method="post" class="form-horizontal">
      ...
      <input name="gender" type="radio" value="Male" required="" <?php if(isset($_GET['edit'])) if($editrow['fld_customer_gender']=="Male") echo "checked"; ?>> Male
  ...
  <div class="radio">
    <label>
       ...
       <input name="gender" type="radio" value="Female" required="" <?php if(isset($_GET['edit'])) if($editrow['fld_customer_gender']=="Female") echo "checked"; ?>> Female
      ...
      <div class="form-group">
          ...
          <div class="col-sm-9">
      <input name="phone" type="text" class="form-control" id="phone" placeholder="Customer Phone" value="<?php if(isset($_GET['edit'])) echo $editrow['fld_customer_phone']; ?>"> <br>
